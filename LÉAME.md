...
**Notas**
- Recuerda que para la comunicacion entre puertos UART es necesario realizar una correcta conexion entre ambos dispositivos tal y como se describe en la siguiente imagen.
  ![thumbnail_maxresdefault](https://github.com/user-attachments/assets/9f765adf-bf28-4f6a-9c08-a38e642eefdb)
- Para personalizar los nombres de las fuentes de audio mostradas en pantalla, modifica la función **mapAudioSource()**. Para agregar nuevos comandos UART o funcionalidades, extiende la función **processUARTCommand()** agregando el comando a la lista de filtros e implementando su lógica correspondiente
